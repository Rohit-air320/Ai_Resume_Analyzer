 ...
 * shows the product's real shape before every destination exists: Settings arrives in
 * Phase 11, and until then it renders as a disabled row with a quiet "Soon" rather than
 * as a link that goes nowhere. A dead link costs a user their trust in the whole nav; a
